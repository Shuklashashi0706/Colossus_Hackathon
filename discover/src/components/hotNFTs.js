...
const HotNftCard = ({ nft, fantokens }) => {
                ...
                <div>
                  {fantokens > 0 ? (
                    <div className='space-y-2' >
                      <div className={`text-2xl ${fantokens > 0 ? "line-through" : ""}`}>{nft?.price} ETH</div>
                      <div className="text-2xl">{nft?.price - (nft?.price * 0.01)} ETH</div>
                    </div>
                  ) : (
